...
using CakeyApp.WindowsPhone.Services;
                ...
                () =>
                    new SQLitePersistentBlobCache(
                        Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData),
                            AppSettings.RequestCacheFileName)),
                typeof (IBlobCache), BlobCacheKeys.RequestCache);

            Locator.CurrentMutable.RegisterLazySingleton(() => new VideoPlayer(), typeof (IVideoPlayerService));

            this._autoSuspendHelper = new AutoSuspendHelper(this);
